...
const styles = StyleSheet.create({
  ...
  brandIcon: { width: 42, height: 42, borderRadius: 12, borderWidth: 1, borderColor: "#DCCCE4" },
  title: { fontSize: 22, lineHeight: 27, fontWeight: "900", color: "#3F3448" },
  subtitle: { marginTop: 1, fontSize: 10, color: "#826F80" },
  periodPicker: { alignSelf: "flex-end", marginTop: -40, position: "relative", zIndex: 20, elevation: 20 },
  periodPickerButton: { alignItems: "center", backgroundColor: "#FFFCFF", borderColor: "#E3D7E7", borderRadius: 10, borderWidth: 1, flexDirection: "row", gap: 6, minWidth: 112, paddingHorizontal: 11, paddingVertical: 8 },
  periodPickerPressed: { opacity: 0.78 },
  periodPickerLabel: { color: "#7653A8", flex: 1, fontSize: 12, fontWeight: "900" },
  periodPickerChevron: { color: "#806F84", fontSize: 14, lineHeight: 16, fontWeight: "900" },
  periodMenu: { backgroundColor: "#FFFCFF", borderColor: "#E3D7E7", borderRadius: 14, borderWidth: 1, maxWidth: 232, minWidth: 218, padding: 10, position: "absolute", right: 0, shadowColor: "#5F496C", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.16, shadowRadius: 12, top: 46, zIndex: 30, elevation: 12 },
  periodMenuSectionLabel: { color: "#826F80", fontSize: 10, fontWeight: "800", marginBottom: 6, marginTop: 8 },
  ...
  periodMenuOptionSelected: { backgroundColor: "#F0E8FA" },
  periodMenuOptionText: { color: "#5B4D62", fontSize: 12, fontWeight: "800" },
  periodMenuOptionTextSelected: { color: "#7653A8" },
  periodMenuCheck: { color: "#7653A8", fontSize: 13, fontWeight: "900" },
  periodOptionGrid: { flexDirection: "row", flexWrap: "wrap", gap: 6 },
  periodChip: { alignItems: "center", borderColor: "#E8DBE6", borderRadius: 8, borderWidth: 1, minWidth: 42, paddingHorizontal: 7, paddingVertical: 7 },
  periodChipSelected: { backgroundColor: "#F0E8FA", borderColor: "#B599D2" },
  periodChipText: { color: "#806F84", fontSize: 11, fontWeight: "800" },
  periodChipTextSelected: { color: "#7653A8" },
  monthPickerSection: { backgroundColor: "#FCF9FF", borderColor: "#E4DAEE", borderRadius: 12, borderWidth: 1, marginTop: 4, overflow: "visible", position: "relative", zIndex: 15, elevation: 15 },
  ...
  monthPickerTitle: { color: "#5B4D62", fontSize: 12, fontWeight: "900" },
  monthPickerSubtitle: { color: "#826F80", fontSize: 10, marginTop: 2 },
  monthPickerIconButton: { alignItems: "center", backgroundColor: "#F0E8FA", borderRadius: 13, height: 26, justifyContent: "center", width: 26 },
  monthPickerIconButtonPressed: { opacity: 0.72 },
  monthPickerChevron: { color: "#7653A8", fontSize: 15, fontWeight: "900", marginTop: -2 },
  monthCurrentButton: { alignItems: "center", borderColor: "#D6C3E8", borderRadius: 7, borderWidth: 1, justifyContent: "center", minWidth: 39, paddingHorizontal: 7, paddingVertical: 5 },
  monthCurrentButtonSelected: { backgroundColor: "#F0E8FA", borderColor: "#7653A8" },
  monthCurrentButtonPressed: { opacity: 0.72 },
  monthCurrentButtonText: { color: "#7653A8", fontSize: 11, fontWeight: "900" },
  monthCurrentButtonTextSelected: { color: "#654394" },
  monthPickerGrid: { backgroundColor: "#FFFCFF", borderColor: "#E4DAEE", borderRadius: 12, borderWidth: 1, elevation: 14, flexDirection: "row", flexWrap: "wrap", gap: 6, left: 0, padding: 10, position: "absolute", right: 0, shadowColor: "#5F496C", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.16, shadowRadius: 12, top: 44, zIndex: 30 },
  monthPickerChip: { alignItems: "center", borderColor: "#E8DBE6", borderRadius: 7, borderWidth: 1, minWidth: 38, paddingHorizontal: 6, paddingVertical: 6 },
  monthPickerChipSelected: { backgroundColor: "#F0E8FA", borderColor: "#B599D2" },
  monthPickerChipText: { color: "#806F84", fontSize: 11, fontWeight: "800" },
  monthPickerChipTextSelected: { color: "#7653A8" },
  ...
  metricCard: { borderRadius: 14, backgroundColor: "#FFFCFF", padding: 10, borderWidth: 1, borderColor: "#EADDE6", minHeight: 78 },
  metricHeading: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  metricLabel: { color: "#806F84", fontSize: 12, fontWeight: "800" },
  metricIcon: { width: 28, height: 28, borderRadius: 14, alignItems: "center", justifyContent: "center", backgroundColor: "#F0E8FA" },
  metricIconExpense: { backgroundColor: "#FBEAF1" },
  metricIconText: { color: "#7653A8", fontSize: 17, fontWeight: "900" },
  metricIconTextExpense: { color: "#C96B8B" },
  metricAmount: { color: "#7653A8", fontSize: 16, lineHeight: 20, fontWeight: "900", marginTop: 9 },
  expenseAmount: { color: "#C96B8B" },
  livingCard: { borderRadius: 14, backgroundColor: "#F5EEFC", padding: 9, borderWidth: 1, borderColor: "#E0D1EE", gap: 5 },
  annualLivingCard: { backgroundColor: "#F5EEFC", borderColor: "#E0D1EE" },
  ...
  panel: { borderRadius: 15, backgroundColor: "#FFFCFF", padding: 10, borderWidth: 1, borderColor: "#EADDE6" },
  panelHeading: { marginBottom: 7 },
  panelTitle: { color: "#3F3448", fontSize: 16, fontWeight: "900" },
  panelSubtitle: { color: "#826F80", fontSize: 10, marginTop: 2 },
