...
const styles = StyleSheet.create({
  ...
  subtitle: { color: "#826F80", marginTop: 5, fontSize: 13, lineHeight: 20 },
  panel: { backgroundColor: "#FFFCFF", borderRadius: 18, padding: 14, borderWidth: 1, borderColor: "#EADDE6" },
  panelTitle: { color: "#3F3448", fontSize: 16, fontWeight: "900", marginBottom: 7 },
  infoText: { color: "#826F80", fontSize: 13, lineHeight: 20 },
  goalControlRow: { alignItems: "center", flexDirection: "row", gap: 8, marginTop: 10 },
  goalInputWrap: { alignItems: "center", backgroundColor: "#FAF5FE", borderColor: "#DECDED", borderRadius: 12, borderWidth: 1, flex: 1, flexDirection: "row", minWidth: 0, paddingHorizontal: 11 },
  goalCurrency: { color: "#7653A8", fontSize: 14, fontWeight: "900", marginRight: 6 },
  goalInput: { color: "#3F3448", flex: 1, fontSize: 16, fontWeight: "900", minWidth: 0, paddingVertical: 10 },
  goalSaveButton: { alignItems: "center", backgroundColor: "#7653A8", borderRadius: 12, justifyContent: "center", minHeight: 42, paddingHorizontal: 13 },
  ...
  goalClearText: { color: "#826F80", fontSize: 12, fontWeight: "800" },
  ...
  ruleCountBadge: { backgroundColor: "#F0E8FA", borderRadius: 9, paddingHorizontal: 8, paddingVertical: 4 },
  ruleCountText: { color: "#7653A8", fontSize: 11, fontWeight: "900" },
  pendingCountBadge: { backgroundColor: "#F4ECFA", borderRadius: 9, paddingHorizontal: 8, paddingVertical: 4 },
  pendingCountText: { color: "#805DA5", fontSize: 11, fontWeight: "900" },
  ruleEmpty: { color: "#826F80", fontSize: 12, lineHeight: 18, marginTop: 11 },
  pendingRow: { borderTopColor: "#EADDE6", borderTopWidth: 1, marginTop: 12, paddingTop: 12 },
  ...
  pendingConfirmButton: { alignItems: "center", backgroundColor: "#F0E8FA", borderRadius: 8, flex: 1, paddingVertical: 7 },
  pendingConfirmText: { color: "#7653A8", fontSize: 11, fontWeight: "900" },
  ...
  ruleRow: { borderTopColor: "#EADDE6", borderTopWidth: 1, marginTop: 12, paddingTop: 12 },
  ...
  ruleToggle: { backgroundColor: "#F9F4FA", borderColor: "#E2D8E5", borderRadius: 9, borderWidth: 1, paddingHorizontal: 8, paddingVertical: 5 },
  ruleToggleActive: { backgroundColor: "#F0E8FA", borderColor: "#CBB6DF" },
  ruleToggleText: { color: "#6D7770", fontSize: 10, fontWeight: "900" },
  ruleToggleTextActive: { color: "#7653A8" },
  ruleActions: { flexDirection: "row", gap: 7, marginTop: 9 },
  ruleActionButton: { alignItems: "center", backgroundColor: "#F4ECFA", borderRadius: 8, flex: 1, paddingVertical: 7 },
  ruleActionText: { color: "#7653A8", fontSize: 11, fontWeight: "900" },
  ruleDeleteButton: { backgroundColor: "#FFF4F1" },
  ruleDeleteText: { color: "#B5472C", fontSize: 11, fontWeight: "900" },
  ruleEditor: { backgroundColor: "#FAF5FE", borderColor: "#DECDED", borderRadius: 11, borderWidth: 1, marginTop: 10, padding: 10 },
  ...
  ruleSaveButton: { alignItems: "center", backgroundColor: "#7653A8", borderRadius: 9, flex: 1, justifyContent: "center", minHeight: 35 },
