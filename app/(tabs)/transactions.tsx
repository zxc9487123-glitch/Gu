...
const styles = StyleSheet.create({
  ...
  title: { color: "#3F3448", fontSize: 22, fontWeight: "900" },
  categoryClearButton: { backgroundColor: "#F0E8FA", borderRadius: 8, paddingHorizontal: 7, paddingVertical: 4 },
  categoryClearText: { color: "#7653A8", fontSize: 10, fontWeight: "900" },
  subtitle: { color: "#826F80", marginTop: 3, fontSize: 10 },
  addButton: { alignItems: "center", backgroundColor: "#7653A8", borderRadius: 10, justifyContent: "center", minHeight: 36, paddingHorizontal: 10 },
  addButtonPressed: { opacity: 0.78, transform: [{ scale: 0.97 }] },
  addButtonText: { color: "#FFFFFF", fontSize: 12, fontWeight: "900" },
  recurringCard: { backgroundColor: "#FFFCFF", borderColor: "#E2D3EA", borderRadius: 14, borderWidth: 1, marginTop: 14, overflow: "hidden" },
  ...
  recurringTitle: { color: "#3F3448", fontSize: 14, fontWeight: "900" },
  recurringPendingBadge: { alignItems: "center", backgroundColor: "#C96B8B", borderRadius: 9, height: 18, justifyContent: "center", minWidth: 18, paddingHorizontal: 4 },
  recurringPendingBadgeText: { color: "#FFFFFF", fontSize: 10, fontWeight: "900" },
  recurringHint: { color: "#826F80", fontSize: 11, marginTop: 4 },
  recurringChevron: { color: "#7653A8", fontSize: 17, fontWeight: "900" },
  recurringBody: { borderTopColor: "#EADDE6", borderTopWidth: 1, padding: 12 },
  recurringDrawerSheet: { backgroundColor: "#FFFCFF", borderTopLeftRadius: 24, borderTopRightRadius: 24, maxHeight: "88%", paddingBottom: 18, paddingHorizontal: 16, paddingTop: 9 },
  recurringDrawerContent: { gap: 11, paddingBottom: 12, paddingTop: 12 },
  recurringSectionTitle: { color: "#56475F", fontSize: 12, fontWeight: "900" },
  pendingSection: { gap: 8 },
  pendingRow: { alignItems: "center", backgroundColor: "#FAF5FE", borderColor: "#DECDED", borderRadius: 11, borderWidth: 1, flexDirection: "row", padding: 9 },
  ...
  pendingName: { color: "#4B3E55", fontSize: 12, fontWeight: "900" },
  pendingMeta: { color: "#826F80", fontSize: 10, marginTop: 2 },
  ...
  pendingDismissButton: { alignItems: "center", backgroundColor: "#F7F1F8", borderRadius: 7, justifyContent: "center", minHeight: 25, paddingHorizontal: 7 },
  pendingDismissText: { color: "#806F84", fontSize: 10, fontWeight: "900" },
  pendingConfirmButton: { alignItems: "center", backgroundColor: "#7653A8", borderRadius: 7, justifyContent: "center", minHeight: 25, paddingHorizontal: 7 },
  ...
  recurringEmptyText: { color: "#826F80", fontSize: 11, lineHeight: 17 },
  ruleSection: { borderTopColor: "#EADDE6", borderTopWidth: 1, gap: 7, marginTop: 11, paddingTop: 11 },
  ...
  ruleName: { color: "#56475F", fontSize: 12, fontWeight: "800" },
  ruleMeta: { color: "#826F80", fontSize: 10, marginTop: 2 },
  ...
  addRecurringButton: { alignItems: "center", backgroundColor: "#F0E8FA", borderColor: "#CBB6DF", borderRadius: 9, borderWidth: 1, justifyContent: "center", marginTop: 11, minHeight: 34 },
  addRecurringText: { color: "#7653A8", fontSize: 11, fontWeight: "900" },
  recurringEditor: { backgroundColor: "#FAF5FE", borderColor: "#DECDED", borderRadius: 11, borderWidth: 1, marginTop: 11, padding: 10 },
  ...
  editorCancelText: { color: "#826F80", fontSize: 10, fontWeight: "900" },
  recurringInput: { backgroundColor: "#FFFCFF", borderColor: "#E0D4E5", borderRadius: 9, borderWidth: 1, color: "#4B3E55", fontSize: 12, minHeight: 37, paddingHorizontal: 10 },
  recurringTypeRow: { flexDirection: "row", gap: 6, marginTop: 8 },
  recurringTypeButton: { alignItems: "center", backgroundColor: "#FFFCFF", borderColor: "#E0D4E5", borderRadius: 8, borderWidth: 1, flex: 1, justifyContent: "center", minHeight: 32 },
  recurringTypeExpenseActive: { backgroundColor: "#FFF0EC", borderColor: "#E7BAAF" },
  recurringTypeIncomeActive: { backgroundColor: "#F0E8FA", borderColor: "#CBB6DF" },
  recurringTypeText: { color: "#806F84", fontSize: 11, fontWeight: "900" },
  recurringInputRow: { flexDirection: "row", gap: 7, marginTop: 8 },
  recurringInputField: { alignItems: "center", backgroundColor: "#FFFCFF", borderColor: "#E0D4E5", borderRadius: 9, borderWidth: 1, flex: 1, flexDirection: "row", minWidth: 0, paddingHorizontal: 9 },
  recurringDayField: { alignItems: "center", backgroundColor: "#FFFCFF", borderColor: "#E0D4E5", borderRadius: 9, borderWidth: 1, flexDirection: "row", paddingHorizontal: 7, width: 104 },
  recurringInputPrefix: { color: "#806F84", fontSize: 10, fontWeight: "800" },
  recurringInlineInput: { color: "#4B3E55", flex: 1, fontSize: 12, minWidth: 0, paddingVertical: 9, paddingHorizontal: 5 },
  recurringDayInput: { color: "#4B3E55", fontSize: 12, minWidth: 22, paddingVertical: 9, paddingHorizontal: 3, textAlign: "center" },
  recurringCategoryGrid: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 8 },
  recurringCategoryChip: { backgroundColor: "#FFFCFF", borderColor: "#E0D4E5", borderRadius: 8, borderWidth: 1, paddingHorizontal: 7, paddingVertical: 5 },
  recurringCategoryChipActive: { backgroundColor: "#F0E8FA", borderColor: "#7653A8" },
  recurringCategoryText: { color: "#806F84", fontSize: 10, fontWeight: "800" },
  recurringCategoryTextActive: { color: "#7653A8" },
  recurringError: { color: "#B5472C", fontSize: 10, fontWeight: "800", marginTop: 7 },
  recurringSaveButton: { alignItems: "center", backgroundColor: "#7653A8", borderRadius: 9, justifyContent: "center", marginTop: 9, minHeight: 35 },
  recurringSaveText: { color: "#FFFFFF", fontSize: 11, fontWeight: "900" },
  filterSummary: { alignItems: "center", backgroundColor: "#FFFCFF", borderColor: "#EADDE6", borderRadius: 12, borderWidth: 1, flexDirection: "row", justifyContent: "space-between", marginTop: 8, minHeight: 50, paddingHorizontal: 10, paddingVertical: 7 },
  ...
  filterSummaryTitle: { color: "#3F3448", fontSize: 14, fontWeight: "900" },
  activeFilterBadge: { alignItems: "center", backgroundColor: "#7653A8", borderRadius: 9, height: 18, justifyContent: "center", minWidth: 18, paddingHorizontal: 4 },
  activeFilterBadgeText: { color: "#FFFFFF", fontSize: 10, fontWeight: "900" },
  filterSummaryText: { color: "#826F80", fontSize: 11, marginTop: 4 },
  filterSummaryTrailing: { alignItems: "flex-end", flexShrink: 0 },
  filterRecordCount: { color: "#7653A8", fontSize: 13, fontWeight: "900" },
  filterSummaryChevron: { color: "#826F80", fontSize: 16, lineHeight: 17, marginTop: 1 },
  fixedListHint: { color: "#826F80", fontSize: 10, marginTop: 5, paddingHorizontal: 2 },
  ...
  drawerSheet: { backgroundColor: "#FFFCFF", borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingBottom: 26, paddingHorizontal: 20, paddingTop: 9 },
  ...
  drawerTitle: { color: "#3F3448", fontSize: 19, fontWeight: "900" },
  drawerHint: { color: "#826F80", fontSize: 11, marginTop: 4 },
  drawerCloseButton: { alignItems: "center", backgroundColor: "#F0E8FA", borderRadius: 9, justifyContent: "center", minHeight: 32, paddingHorizontal: 10 },
  drawerCloseButtonPressed: { opacity: 0.72 },
  drawerCloseText: { color: "#7653A8", fontSize: 12, fontWeight: "900" },
  clearButton: { alignItems: "center", backgroundColor: "#F0E8FA", borderRadius: 9, justifyContent: "center", minHeight: 30, minWidth: 42, paddingHorizontal: 8 },
  clearButtonDisabled: { backgroundColor: "#F7F1F8" },
  clearButtonPressed: { opacity: 0.7 },
  clearButtonText: { color: "#7653A8", fontSize: 12, fontWeight: "900" },
  clearButtonTextDisabled: { color: "#A6ACA7" },
  filterLabel: { color: "#5B4D62", fontSize: 12, fontWeight: "800", marginTop: 11, marginBottom: 5 },
  dateShortcutRow: { flexDirection: "row", gap: 7, marginBottom: 8 },
  dateShortcutButton: { alignItems: "center", backgroundColor: "#F0E8FA", borderColor: "#CBB6DF", borderRadius: 8, borderWidth: 1, flex: 1, paddingVertical: 7 },
  dateShortcutPressed: { opacity: 0.72 },
  dateShortcutText: { color: "#7653A8", fontSize: 11, fontWeight: "900" },
  inputRow: { alignItems: "center", flexDirection: "row", width: "100%" },
  filterInput: { backgroundColor: "#FFF5F8", borderColor: "#E8DBE6", borderRadius: 10, borderWidth: 1, color: "#3F3448", flexBasis: 0, flexGrow: 1, flexShrink: 1, fontSize: 12, minHeight: 40, minWidth: 0, paddingHorizontal: 8 },
  rangeDivider: { color: "#826F80", flexShrink: 0, fontSize: 12, fontWeight: "700", marginHorizontal: 6 },
  sortRow: { flexDirection: "row", gap: 4, width: "100%" },
  sortButton: { alignItems: "center", backgroundColor: "#FFF5F8", borderColor: "#E8DBE6", borderRadius: 7, borderWidth: 1, flex: 1, justifyContent: "center", minHeight: 28, minWidth: 0, paddingHorizontal: 2 },
  sortButtonActive: { backgroundColor: "#F0E8FA", borderColor: "#7653A8" },
  sortButtonPressed: { opacity: 0.7 },
  sortButtonText: { color: "#806F84", fontSize: 10, fontWeight: "800" },
  sortButtonTextActive: { color: "#7653A8" },
  ...
  filterResult: { color: "#7653A8", fontSize: 11, fontWeight: "800", marginTop: 10 },
  row: { flexDirection: "row", alignItems: "center", backgroundColor: "#FFFCFF", paddingHorizontal: 10, paddingVertical: 8 },
  rowPressed: { backgroundColor: "#F5ECFA", opacity: 0.86 },
  typeBadge: { width: 38, height: 38, borderRadius: 19, alignItems: "center", justifyContent: "center" },
  incomeBadge: { backgroundColor: "#F0E8FA" },
  expenseBadge: { backgroundColor: "#FBEAF1" },
  typeBadgeText: { fontSize: 14, fontWeight: "900" },
  incomeText: { color: "#7653A8" },
  expenseText: { color: "#C96B8B" },
  rowMain: { flex: 1, marginLeft: 11, minWidth: 0 },
  category: { color: "#3F3448", fontSize: 15, fontWeight: "800" },
  rowMeta: { color: "#826F80", fontSize: 12, marginTop: 3 },
  rowValue: { alignItems: "flex-end", marginLeft: 8 },
  amount: { fontSize: 14, fontWeight: "900" },
  rowDate: { color: "#9A8B9B", fontSize: 11, marginTop: 3 },
  separator: { height: 4 },
  emptyCard: { marginTop: 60, padding: 24, alignItems: "center", borderRadius: 20, backgroundColor: "#FFFCFF", borderWidth: 1, borderColor: "#EADDE6" },
  emptyTitle: { color: "#3F3448", fontSize: 17, fontWeight: "900" },
  emptyText: { color: "#826F80", textAlign: "center", fontSize: 13, lineHeight: 20, marginTop: 8 },
});
