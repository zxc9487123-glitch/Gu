...
const styles = StyleSheet.create({
  ...
  sortButton: { alignItems: "center", backgroundColor: "#F8F6F1", borderColor: "#E8E3DA", borderRadius: 7, borderWidth: 1, flex: 1, justifyContent: "center", minHeight: 28, minWidth: 0, paddingHorizontal: 2 },
  sortButtonActive: { backgroundColor: "#E7F2ED", borderColor: "#0E6B56" },
  sortButtonPressed: { opacity: 0.7 },
  sortButtonText: { color: "#647068", fontSize: 10, fontWeight: "800" },
