...
const styles = StyleSheet.create({
  ...
  treemap: { height: 168, flexDirection: "row", gap: 5, borderRadius: 14, overflow: "hidden" },
  treemapLargest: { flex: 1.05, justifyContent: "center", alignItems: "center", padding: 10 },
  treemapLargestLabel: { color: "#FFFFFF", fontSize: 14, fontWeight: "800", textAlign: "center" },
  treemapLargestRatio: { color: "#FFFFFF", fontSize: 22, fontWeight: "900", marginTop: 4 },
  ...
  treemapBlockLabel: { color: "#FFFFFF", fontSize: 11, fontWeight: "800", textAlign: "center", lineHeight: 15 },
  treemapCompactLabel: { fontSize: 9, lineHeight: 13 },
  treemapBlockRatio: { color: "#FFFFFF", fontSize: 15, fontWeight: "900", marginTop: 2 },
