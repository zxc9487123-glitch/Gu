...
const styles = StyleSheet.create({
  ...
  title: { color: "#3F3448", fontSize: 16, fontWeight: "900" },
  description: { color: "#826F80", fontSize: 12, lineHeight: 18, marginTop: 5 },
  selectButton: { marginTop: 10, borderRadius: 12, paddingVertical: 10, alignItems: "center", backgroundColor: "#F0E8FA", borderWidth: 1, borderColor: "#CBB6DF" },
  selectText: { color: "#7653A8", fontSize: 13, fontWeight: "900" },
  pressed: { opacity: 0.75 },
  disabled: { opacity: 0.5 },
  filename: { color: "#4F5B54", fontSize: 12, marginTop: 10 },
  error: { color: "#B5472C", fontSize: 12, lineHeight: 18, marginTop: 10 },
  success: { color: "#7653A8", fontSize: 12, lineHeight: 18, marginTop: 10, fontWeight: "800" },
  preview: { marginTop: 15, paddingTop: 14, borderTopWidth: 1, borderTopColor: "#EADDE6" },
  previewTitle: { color: "#3F3448", fontSize: 14, fontWeight: "900" },
  ...
  modeRow: { flexDirection: "row", alignItems: "center", gap: 12, marginTop: 13, padding: 11, borderRadius: 12, backgroundColor: "#FFF5F8", borderWidth: 1, borderColor: "#EADDE6" },
  modeRowActive: { backgroundColor: "#F0E8FA", borderColor: "#CBB6DF" },
  modeCopy: { flex: 1 },
  ...
  switchTrackActive: { backgroundColor: "#7653A8" },
  switchThumb: { width: 16, height: 16, borderRadius: 8, backgroundColor: "#FFFFFF", alignSelf: "flex-start" },
  switchThumbActive: { alignSelf: "flex-end" },
  keywordPanel: { marginTop: 13, padding: 11, borderRadius: 12, backgroundColor: "#FAF5FE", borderWidth: 1, borderColor: "#DECDED" },
  rulePanel: { marginTop: 13, padding: 11, borderRadius: 12, backgroundColor: "#FAF5FE", borderWidth: 1, borderColor: "#DECDED" },
  ...
  applySavedRulesButton: { alignItems: "center", backgroundColor: "#FFFCFF", borderColor: "#CBB6DF", borderRadius: 8, borderWidth: 1, minHeight: 30, paddingHorizontal: 8 },
  applySavedRulesText: { color: "#7653A8", fontSize: 10, fontWeight: "900" },
  ...
  keywordIncomeButton: { backgroundColor: "#F0E8FA", borderColor: "#CBB6DF" },
  keywordExpenseText: { color: "#C85F3A", fontSize: 10, fontWeight: "900", textAlign: "center" },
  keywordIncomeText: { color: "#7653A8", fontSize: 10, fontWeight: "900", textAlign: "center" },
  ...
  ruleTypeIncomeActive: { backgroundColor: "#F0E8FA", borderColor: "#CBB6DF" },
  ruleTypeText: { color: "#69756E", fontSize: 11, fontWeight: "900" },
  ruleTypeExpenseText: { color: "#C85F3A" },
  ruleTypeIncomeText: { color: "#7653A8" },
  ...
  ruleCategoryChipActive: { backgroundColor: "#F0E8FA", borderColor: "#7653A8" },
  ruleCategoryText: { color: "#66736B", fontSize: 10, fontWeight: "800" },
  ruleCategoryTextActive: { color: "#7653A8" },
  ruleError: { color: "#B5472C", fontSize: 10, fontWeight: "800", marginTop: 7 },
  saveRuleButton: { alignItems: "center", backgroundColor: "#7653A8", borderRadius: 9, justifyContent: "center", marginTop: 9, minHeight: 35 },
  ...
  confirmButton: { marginTop: 15, borderRadius: 13, paddingVertical: 12, alignItems: "center", backgroundColor: "#7653A8" },
